         ...
         <div id="content-wrapper">
            <div class="container-fluid">
               <div class="video-block section-padding">
                     ...
                     <div class="col-md-12">
                        <div class="main-title">
                           <div class="float-right">
                            <a class="dropdown-item" href="code.php?action=clear">
                              <i class="fas fa-fw fa-star"></i> &nbsp; Clear History</a>
                            </div>
                           <h6>Watch History</h6>
                           <hr>
                        </div>
                  ...
                  <?php
                    $srh = $history->find(['sem'=>$_SESSION['sem'],'user'=>$_SESSION['user']],['sort'=>['_id'=>-1]] ); 
                    $res = $history->count( ['sem'=>$_SESSION['sem'],'user'=>$_SESSION['user']] );
                    if($res==0)
                    {
                      echo 
